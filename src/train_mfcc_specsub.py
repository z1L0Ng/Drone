# --- MFCC + Spectral Subtraction, SNR -25dB to -10dB ---
...
MODELS_PATH = "saved_models/mfcc_specsub/"
RESULT_PATH = "result/mfcc_specsub/"
...
try:
    ...
    plt.title('MFCC+SpecSub Accuracy')
    plt.legend()
    plt.subplot(1, 2, 2)
    plt.plot(history.history['loss'], label='Train')
    plt.plot(history.history['val_loss'], label='Val')
    plt.title('MFCC+SpecSub Loss')
    plt.legend()
...
try:
    ...
    plt.title('MFCC+SpecSub Confusion Matrix')
    plt.ylabel('True')
