# --- Log-Mel Spectrogram, SNR -30dB to -20dB ---
...
MODELS_PATH = "saved_models/logmel/"
...
# Frontend params (match your model constraints)
N_MELS = 256
N_FFT = 1024
HOP_LENGTH = 512
CENTER = False
...
plt.title('Log-Mel Accuracy')
plt.legend()
plt.subplot(1, 2, 2)
plt.plot(history.history['loss'], label='Train')
plt.plot(history.history['val_loss'], label='Val')
plt.title('Log-Mel Loss')
plt.legend()
...
plt.title('Log-Mel Confusion Matrix')
plt.ylabel('True')
