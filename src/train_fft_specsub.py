...
RESULT_PATH = "result/fft_specsub/"
...
plt.title('FFT+SpecSub Accuracy')
plt.legend()
plt.subplot(1, 2, 2)
plt.plot(history.history['loss'], label='Train')
plt.plot(history.history['val_loss'], label='Val')
plt.title('FFT+SpecSub Loss')
plt.legend()
...
plt.title('FFT+SpecSub Confusion Matrix')
plt.ylabel('True')
