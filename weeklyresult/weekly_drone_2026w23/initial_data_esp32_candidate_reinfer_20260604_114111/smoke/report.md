...
- macro F1: 0.1111
- emergency precision / recall / F1: 0.2500 / 0.5000 / 0.3333
- movement recall / F1: 0.0000 / 0.0000
- unknown false event rate: 1.0000
...
|---|---:|---:|---:|---:|---:|---:|
| hongjun | 6 | 0.1667 | 0.5000 | 0.0000 | 1.0000 | 0.1111 |

## Intent Summary

| intent | support | precision | recall | F1 |
|---|---:|---:|---:|---:|
| emergency | 2 | 0.2500 | 0.5000 | 0.3333 |
| movement | 2 | 0.0000 | 0.0000 | 0.0000 |
| unknown | 2 | 0.0000 | 0.0000 | 0.0000 |

## Keyword Summary

| intent | keyword | support | accuracy | most common wrong prediction |
|---|---|---:|---:|---|
| emergency | freeze | 2 | 0.5000 | unknown |
| movement | down | 2 | 0.0000 | emergency |
| unknown | no | 2 | 0.0000 | emergency |
