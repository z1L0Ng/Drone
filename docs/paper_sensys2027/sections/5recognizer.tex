...
\begin{figure*}[t]
    ...
    \caption{Recognizer design. A teacher recognizer guides a student recognizer through distillation while both use the same log-mel input and Branchformer-style event recognizer; the deployed student path emits the intent output and is exported for ESP32 int8 inference.}
