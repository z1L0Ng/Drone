...
\author{Zilong Zeng, Junxi Xia, R. R. Venkatesha Prasad, and Stephen Xia%
\thanks{Zilong Zeng, Junxi Xia, and Stephen Xia are with Northwestern University, Evanston, IL, USA (e-mail: \{zilongzeng2030, JunxiXia2024\}@u.northwestern.edu; stephen.xia@northwestern.edu). Stephen Xia is the corresponding author.}%
\thanks{R. R. Venkatesha Prasad is with Delft University of Technology, Delft, The Netherlands (e-mail: R.R.VenkateshaPrasad@tudelft.nl).}}
...
\input{sections/2system}
\input{sections/3demo}
\input{sections/4realworld}
